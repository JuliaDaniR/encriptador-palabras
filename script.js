...
/*function validarTexto(texto) {
  ...
  if (/[A-ZÁÉÍÓÚÜÑ]/.test(texto)) {
     ...
     mensajeError.innerHTML = "No se permiten mayúsculas o letras con acentos. Por favor, ingrese solo minúsculas sin acentos.";
     ...
     // Devolver false para indicar que la validación ha fallado
     return false;
   }

  // Verificar caracteres especiales
  if (/[^a-záéíóúüñ\s]/i.test(texto)) {
    alert(
      "No se permiten caracteres especiales o letras con acentos. Por favor, ingrese solo letras minúsculas sin acentos."
    );
    return false;
  }
...
function validarTexto(texto) {
  ...
  if (/[A-ZÁÉÍÓÚÜÑ]/.test(texto)) {
    mostrarMensajeError(
      "No se permiten mayúsculas o letras con acentos. Por favor, ingrese solo minúsculas sin acentos."
    );
    return false;
  }
  ...
  if (/[^a-z\s]/i.test(texto)) {
    mostrarMensajeError(
      "No se permiten caracteres especiales. Por favor, ingrese solo letras minúsculas sin acentos."
    );
    return false;
  }
